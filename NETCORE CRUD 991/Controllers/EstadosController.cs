...
namespace NETCORE_CRUD_991.Controllers
{
    public class EstadosController : Controller
    {
        ...
        {
            return View(await _context.estadoss.ToListAsync());
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var estado = await _context.estadoss
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var estado = await _context.estadoss.FindAsync(id);
            if (estado == null)
            {
                return NotFound();
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdEstado,Estados")] Estado estado)
        {
        ...
        {
            var estado = await _context.estadoss.FindAsync(id);
            _context.estadoss.Remove(estado);
            await _context.SaveChangesAsync();
            return RedirectToAction(nameof(Index));
        }
        ...
        {
            return _context.estadoss.Any(e => e.IdEstado == id);
        }
    }
}
